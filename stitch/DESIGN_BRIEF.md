...
- Signal Desk Canary turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a small single-page tracker called Signal Desk Canary. It should show three status rows, let the user toggle each row between ok/warn/down, persist state in localStorage, expose window.app with getState and reset methods, and include reset plus export controls. Keep it static HTML, CSS, and JavaScript…
...
- Record Operations - Signal Desk Canary
- Record Editor - Signal Desk Canary
- Insights - Signal Desk Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Signal Desk Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Signal Desk Canary
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Signal Desk Canary
